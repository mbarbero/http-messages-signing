...
public class RFCData {
	...
	public static String SIGNING_STRING__DEFAULT_TEST = "date: Sun, 05 Jan 2014 21:31:40 GMT";
	
	public static String SIGNING_STRING__BASIC_TEST = 
			"(request-target): post /foo?param=value&pet=dog\n" + 
			"host: example.com\n" + 
			"date: Sun, 05 Jan 2014 21:31:40 GMT";
	
	public static String SIGNING_STRING__ALL_HEADERS_TEST = 
			"(request-target): post /foo?param=value&pet=dog\n" + 
			"host: example.com\n" + 
			"date: Sun, 05 Jan 2014 21:31:40 GMT\n" + 
	...
	public static final String SIGNATURE_HEADER_VALUE__DEFAULT_TEST = 
			"keyId=\""+KEY_ID+"\",algorithm=\"rsa-sha256\"," + 
			"signature=\"SjWJWbWN7i0wzBvtPl8rbASWz5xQW6mcJmn+ibttBqtifLN7Sazz" + 
			"6m79cNfwwb8DMJ5cou1s7uEGKKCs+FLEEaDV5lp7q25WqS+lavg7T8hc0GppauB" + 
			"6hbgEKTwblDHYGEtbGmtdHgVCk9SuS13F0hZ8FD0k/5OxEPXe5WozsbM=\"";

	public static String SIGNATURE_HEADER__DEFAULT_TEST =
			"Signature: " + SIGNATURE_HEADER_VALUE__DEFAULT_TEST;
	
	public static final String SIGNATURE_HEADER_VALUE__BASIC_TEST = 
			"keyId=\""+KEY_ID+"\",algorithm=\"rsa-sha256\"," + 
	...
	public static String SIGNATURE_HEADER__BASIC_TEST =
			"Signature: " + SIGNATURE_HEADER_VALUE__BASIC_TEST;
	
	public static final String SIGNATURE_HEADER_VALUE__ALL_HEADERS_TEST = 
			"keyId=\""+KEY_ID+"\",algorithm=\"rsa-sha256\"," + 
	...
	public static String SIGNATURE_HEADER__ALL_HEADERS_TEST =
			"Signature: " + SIGNATURE_HEADER_VALUE__ALL_HEADERS_TEST;
